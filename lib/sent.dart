...
class HomeScreenst extends StatefulWidget {
  const HomeScreenst({super.key});

  @override
  State<HomeScreenst> createState() => _HomeScreentwState();
}

class _HomeScreentwState extends State<HomeScreenst> {
  ...
  sendLocationToServer(double latitude, double longitude) async {
    final String serverUrl =
        'https://db23-49-249-101-106.ngrok-free.app/save-location';
